import{i as N,j as t,_ as W,s as L,b as C,F as _,H as E,a as X,g as U,r as u,u as F,J as q,d as G,e as V,T as p,B as y,C as J,G as B,P as $,L as R,t as k,K as T,v as w,D as K,M as Q,N as Y}from"./index-D936J5q9.js";import{A as Z}from"./Avatar-YHinppQR.js";import{B as tt}from"./MenuBook-DGzH5gKp.js";import{T as rt}from"./TextField-F91nJMJ9.js";import{I as st,S as ot}from"./Search-AV7x1iTZ.js";import{E as lt}from"./ExpandMore-DyznzoRd.js";import{C as et}from"./Collapse-BqW3NGCD.js";import{C as nt}from"./Card-DJQ2oUgh.js";import{C as it}from"./CardContent-CSkjCqC3.js";import"./useControlled-CmxBW1ow.js";const at=N(t.jsx("path",{d:"M6 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm12 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm-6 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"}),"MoreHoriz"),pt=["slots","slotProps"],ct=L(_)(({theme:r})=>C({display:"flex",marginLeft:`calc(${r.spacing(1)} * 0.5)`,marginRight:`calc(${r.spacing(1)} * 0.5)`},r.palette.mode==="light"?{backgroundColor:r.palette.grey[100],color:r.palette.grey[700]}:{backgroundColor:r.palette.grey[700],color:r.palette.grey[100]},{borderRadius:2,"&:hover, &:focus":C({},r.palette.mode==="light"?{backgroundColor:r.palette.grey[200]}:{backgroundColor:r.palette.grey[600]}),"&:active":C({boxShadow:r.shadows[0]},r.palette.mode==="light"?{backgroundColor:E(r.palette.grey[200],.12)}:{backgroundColor:E(r.palette.grey[600],.12)})})),gt=L(at)({width:24,height:16});function dt(r){const{slots:o={},slotProps:i={}}=r,g=W(r,pt),n=r;return t.jsx("li",{children:t.jsx(ct,C({focusRipple:!0},g,{ownerState:n,children:t.jsx(gt,C({as:o.CollapsedIcon,ownerState:n},i.collapsedIcon))}))})}function ut(r){return U("MuiBreadcrumbs",r)}const ht=X("MuiBreadcrumbs",["root","ol","li","separator"]),xt=["children","className","component","slots","slotProps","expandText","itemsAfterCollapse","itemsBeforeCollapse","maxItems","separator"],mt=r=>{const{classes:o}=r;return V({root:["root"],li:["li"],ol:["ol"],separator:["separator"]},ut,o)},Ct=L(p,{name:"MuiBreadcrumbs",slot:"Root",overridesResolver:(r,o)=>[{[`& .${ht.li}`]:o.li},o.root]})({}),ft=L("ol",{name:"MuiBreadcrumbs",slot:"Ol",overridesResolver:(r,o)=>o.ol})({display:"flex",flexWrap:"wrap",alignItems:"center",padding:0,margin:0,listStyle:"none"}),Pt=L("li",{name:"MuiBreadcrumbs",slot:"Separator",overridesResolver:(r,o)=>o.separator})({display:"flex",userSelect:"none",marginLeft:8,marginRight:8});function bt(r,o,i,g){return r.reduce((n,f,h)=>(h<r.length-1?n=n.concat(f,t.jsx(Pt,{"aria-hidden":!0,className:o,ownerState:g,children:i},`separator-${h}`)):n.push(f),n),[])}const At=u.forwardRef(function(o,i){const g=F({props:o,name:"MuiBreadcrumbs"}),{children:n,className:f,component:h="nav",slots:P={},slotProps:I={},expandText:H="Show path",itemsAfterCollapse:b=1,itemsBeforeCollapse:A=1,maxItems:j=8,separator:a="/"}=g,s=W(g,xt),[l,e]=u.useState(!1),x=C({},g,{component:h,expanded:l,expandText:H,itemsAfterCollapse:b,itemsBeforeCollapse:A,maxItems:j,separator:a}),m=mt(x),D=q({elementType:P.CollapsedIcon,externalSlotProps:I.collapsedIcon,ownerState:x}),M=u.useRef(null),O=d=>{const S=()=>{e(!0);const z=M.current.querySelector("a[href],button,[tabindex]");z&&z.focus()};return A+b>=d.length?d:[...d.slice(0,A),t.jsx(dt,{"aria-label":H,slots:{CollapsedIcon:P.CollapsedIcon},slotProps:{collapsedIcon:D},onClick:S},"ellipsis"),...d.slice(d.length-b,d.length)]},v=u.Children.toArray(n).filter(d=>u.isValidElement(d)).map((d,S)=>t.jsx("li",{className:m.li,children:d},`child-${S}`));return t.jsx(Ct,C({ref:i,component:h,color:"text.secondary",className:G(m.root,f),ownerState:x},s,{children:t.jsx(ft,{className:m.ol,ref:M,ownerState:x,children:bt(l||j&&v.length<=j?v:O(v),m.separator,a,x)})}))}),jt=N(t.jsx("path",{d:"m12 8-6 6 1.41 1.41L12 10.83l4.59 4.58L18 14z"}),"ExpandLess"),c={title:"Allcare Health Care, LLC 客户信息手册",subtitle:"All People. All Heart. Allcare.",phone:"240 668 4666",effectiveDate:"2024年7月",description:"为客户提供全面的护理服务指导和重要信息",chapters:[{id:"welcome",title:"1. 欢迎来到 Allcare Health Care, LLC",sections:[{id:"mission",title:"我们的使命与承诺",content:`
